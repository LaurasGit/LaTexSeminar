...
\begin{document}
	...
	Beim Reinforcement Learning werden intelligente Programme, die Agenten genannt werden genutzt.(Nandy, S.1) Hierbei gibt es keine Trainings-Daten.(Nandy, S.2)  Ein Agent trainiert um sich seiner Umgebung anzupassen und seine Leistung zu verbessern.(Sarkar, S.42) \newline
	...
	Die Aktionen erfolgen durch Ausprobieren, da es sehr schwer ist von beginn an vorauszusagen welche Aktion in welchen Zustand ausgeführt werden muss.(Nandy, S.5) Der Agent besitzt bereits zu beginn bestimmte Strategien und Richtlinien, diese werden verbessert und angepasst.(Sarkar, S.43) 
	Abhängig von der Interaktion mit der Umgebung erhält der Agent von der Umgebung Belohnungen und Bestrafungen, meist in vorm von plus und minus Punkten.(Nandy, S.2) Diese führen zu einem Update der Strategien um mehr Belohnungen zu erhalten.(Sarkar, S.42)\newline
	Reinforcement Learning wird auch lernen mir einem Kritiker genannt, da dem Modell nicht gesagt wird was es tun soll, sondern erst nach dem ausführen der Aktionen eine Rückmeldung über diese an das Modell weitergegeben wird.(Alpaydin, S.374)
	...
	beschränkt oder fortlaufend und single oder multiagent
