...
\begin{document}
	...
	Support Vector Maschinen oder auch kurz SVMs, sind vielseitige und mächtige Machine Learning Modelle. Sie zählen zu den beliebtesten Modellen und eignen sich für lineare, nicht-lineare Klassifikation, Regression und Anomalie Erkennung. \cite{Geron2017} SVMs können mathematisch sehr komplex sein und eine hohe Rechenleistung erfordern. \cite{Suthaharan.2016} Im Folgenden wird nur lineare Klassifikation betrachtet.\newline
	...
	Im Folgenden wird mit der scikit-learn Bibliothek ein SVM-Modell erstellt und mit fit trainiert. X\_train und y\_train beinhalten die Trainings-Datensätze. Mit Hilfe von predict kann ein neuer Datensatz klassifiziert werden.
	\lstset{style=code}
	...
	\begin{figure}[h!]
		\centering
		\includegraphics[width=5cm]{Bilder/Umgebung.png}
